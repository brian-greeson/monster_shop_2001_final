...
RSpec.describe 'As an merchant user', type: :feature do
  ...
  describe 'From my discounts index page' do
    it 'I can delete my discounts' do
      discount1 = @tire.bulk_discounts.create!(quantity: 2, discount: 10)
      discount2 = @bottle.bulk_discounts.create!(quantity: 3, discount: 20)
      ...
      within ".item-#{@tire.id}-discounts" do
        expect(page).to_not have_content("Discount of: #{discount1.discount}% on quantities higher than #{discount1.quantity} units")
      end
